			...
			<c:choose>
				<c:when test="${empty sessionId}">
					<ul class="navbar_menu">
						...
						<li><a href="#map_container">놀 맵</a></li>
					...
					<div id="search">
						<form action="instar/instar.jsp" method="get">
					...
					<div id="login">
						<a href="users/loginform.jsp"><img
				...
				<c:otherwise>
					...
					<div>
						<ul class="navbar_menu" id="login_info">
	...
	<div id="container">
			...
			<div class="swiper">
				...
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						<a href="https://korean.visitkorea.or.kr/trss/intro.do"><img
							src="resources/images/bigslide1.png" alt="Slide 1"></a>
					</div>
					<div class="swiper-slide">
						<a href="event/event_page4.jsp"><img
							src="resources/images/bigslide2.png" alt="Slide 2"></a>
					</div>
					<div class="swiper-slide">
						<a href="https://vangoghexpo.com/seoul/"><img
							src="resources/images/bigslide3.png" alt="Slide 3"></a>
					</div>
				</div>
			...
			<div class="event_slide_box">
				<div class="event_slide_menu">
					<div class="event_slide_title">
						<a href="event/eventlist.jsp">이벤트 및 혜택 모아보기</a>
					</div>
				</div>
				<div class="event_slide_wrapper">
					<div class="slider owl-carousel">
						<div class="card">
							<div class="img">
								<a href="event/event_page3.jsp"><img
						...
						<div class="card">
							<div class="img">
								<a href="event/event_page2.jsp"><img
		...
		<section class="recommend_page">
			<div class="recommend_div">
				...
				<h2 class="mtit">
					<a href="today_nollaeng_page/ptoday.jsp">✔ 이번 주 BEST</a>
				</h2>
				<p class="stit">
			...
			<div class="row my-4">
				<div class="col-4">
					<div class="card">
						...
						<a href="instar/instar2.jsp"><img
							src="resources/images/weekB.jpg" class="card-img-top" alt="..."></a>
						<div class="card-body">
				...
				<div class="col-4">
					<div class="card">
						<a href="instar/instar2.jsp"><img
							src="resources/images/weekB2.jpg" class="card-img-top" alt="..."></a>
						<div class="card-body">
				...
				<div class="col-4">
					<div class="card">
						<a href="instar/instar2.jsp"><img
							src="resources/images/weekB3.jpg" class="card-img-top" alt="..."></a>
						<div class="card-body">
			...
			<div class="row">
				<div class="col-4">
					<div class="card">
						<a href="instar/instar2.jsp"><img
							src="resources/images/weekB4.jpg" class="card-img-top" alt="..."></a>
						<div class="card-body">
				...
				<div class="col-4">
					<div class="card">
						<a href="instar/instar2.jsp"><img
							src="resources/images/weekB5.jpg" class="card-img-top" alt="..."></a>
						<div class="card-body">
				...
				<div class="col-4">
					<div class="card">
						<a href="instar/instar2.jsp"><img
							src="resources/images/weekB6.jpg" class="card-img-top" alt="..."></a>
						<div class="card-body">
